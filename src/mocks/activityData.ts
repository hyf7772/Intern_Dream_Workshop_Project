...
export const activityOverviews: Record<ActivityOverviewConfig['id'], ActivityOverviewConfig> = {
  general: {
    ...
    items: [
      ...
      { id: 'five-call', name: '五连 call 打卡', type: '成长打卡', publisher: '王琳', department: '培训发展部', date: '2026-08-06', time: '09:00 ~ 18:00', location: '线上 + 线下', enrollment: '80/100', stars: 50, status: '报名中', icon: '📞' },
      { id: 'outreach', name: '素质拓展活动', type: '团队共创', publisher: '李然', department: '企业文化部', date: '2026-08-08', time: '09:30 ~ 17:30', location: '青龙湖拓展基地', enrollment: '45/60', stars: 60, status: '进行中', icon: '⛺' },
      { id: 'forum', name: '实习生座谈会', type: '交流座谈', publisher: '张悦', department: '人力资源部', date: '2026-08-10', time: '14:00 ~ 16:00', location: '多功能会议厅', enrollment: '28/40', stars: 40, status: '报名中', icon: '👥' },
      { id: 'orientation', name: '实习生入职培训', type: '成长培训', publisher: '王琳', department: '培训发展部', date: '2026-08-12', time: '09:00 ~ 17:00', location: '总部培训室 A', enrollment: '120/120', stars: 60, status: '已结束', icon: '📖' },
      { id: 'company-walk', name: '喵厂 company walk', type: '文化体验', publisher: '李然', department: '企业文化部', date: '2026-08-14', time: '15:00 ~ 16:30', location: '园区主要路线', enrollment: '51/80', stars: 30, status: '进行中', icon: '🐾' },
      { id: 'basketball', name: '梦工场篮球活动赛', type: '文体活动', publisher: '陈宇', department: '行政管理部', date: '2026-08-16', time: '18:30 ~ 20:30', location: '园区篮球馆', enrollment: '64/80', stars: 50, status: '报名中', icon: '🏀' },
      { id: 'six-growth', name: '成长六计——沉浸式打卡挑战赛', type: '成长打卡', publisher: '张悦', department: '人力资源部', date: '2026-08-18', time: '09:00 ~ 18:00', location: '线上', enrollment: '170/200', stars: 60, status: '未发布', icon: '🏆' },
    ],
  },
  professional: {
    id: 'professional',
