...
export const activityOverviews: Record<ActivityOverviewConfig['id'], ActivityOverviewConfig> = {
  general: {
    ...
    items: [
      { id: 'new-employee-class', name: '职场进阶 我有一招 新员工小课堂', type: '成长培训', publisher: '阳洁', department: '人力资源部', date: '2026-08-05', time: '14:00 ~ 16:00', location: '分行培训室', enrollment: '36/50', stars: 30, status: '未发布', icon: '🎓' },
      ...
      { id: 'outreach', name: '素质拓展活动', type: '团队共创', publisher: '李然', department: '人力资源部', date: '2026-08-08', time: '09:30 ~ 17:30', location: '火炉山森林公园', enrollment: '45/60', stars: 60, status: '进行中', icon: '⛺' },
      ...
      { id: 'orientation', name: '实习生入职培训', type: '成长培训', publisher: '孙浩哲', department: '人力资源部', date: '2026-08-12', time: '09:00 ~ 17:00', location: '分行培训室 ', enrollment: '120/120', stars: 60, status: '已结束', icon: '📖' },
