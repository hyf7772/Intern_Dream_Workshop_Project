...
export const initialGifts: GiftItem[] = [
  { id: 'g01', name: '招商银行帆布袋', points: 200, stock: 50, status: '上架', category: '实用周边' },
  { id: 'g02', name: '招商银行保温杯', points: 300, stock: 22, status: '上架', category: '实用周边' },
  { id: 'g03', name: '招商银行晴雨伞', points: 300, stock: 0, status: '下架', category: '实用周边' },
  { id: 'g04', name: '招商银行笔记本礼盒', points: 500, stock: 16, status: '上架', category: '文创礼盒' },
  { id: 'g05', name: '招商银行小招喵公仔', points: 800, stock: 22, status: '上架', category: '文创礼盒' },
  { id: 'g06', name: '招商银行马克杯', points: 500, stock: 50, status: '编辑中', category: '实用周边' },
  { id: 'g07', name: '招商银行鼠标垫', points: 200, stock: 0, status: '下架', category: '实用周边' },
  { id: 'g08', name: '招商银行文创盲盒', points: 1000, stock: 16, status: '编辑中', category: '文创礼盒' },
]
