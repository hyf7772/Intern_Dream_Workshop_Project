...
import { giftImages } from '../constants/assets'
...
export const initialGifts: GiftItem[] = [
  { id: 'g01', name: '徽章礼盒', image: giftImages.g01, points: 200, stock: 50, status: '上架', category: '文创礼盒' },
  { id: 'g02', name: '向日葵马克杯', image: giftImages.g02, points: 300, stock: 22, status: '上架', category: '实用周边' },
  { id: 'g03', name: '星空马克杯', image: giftImages.g03, points: 300, stock: 0, status: '下架', category: '实用周边' },
  { id: 'g04', name: '小招喵纸巾盒', image: giftImages.g04, points: 500, stock: 16, status: '上架', category: '实用周边' },
  { id: 'g05', name: '小招喵方形周边', image: giftImages.g05, points: 800, stock: 22, status: '上架', category: '文创礼盒' },
  { id: 'g06', name: '小招喵马克杯', image: giftImages.g06, points: 500, stock: 50, status: '编辑中', category: '实用周边' },
  { id: 'g07', name: '小招喵挂饰套装', image: giftImages.g07, points: 200, stock: 0, status: '下架', category: '文创礼盒' },
  { id: 'g08', name: '小招喵拖鞋', image: giftImages.g08, points: 1000, stock: 16, status: '编辑中', category: '实用周边' },
]

export const initialRedemptionRecords: RedemptionRecord[] = [
  {
    id: 'e01', giftId: 'g01', giftName: '徽章礼盒', image: giftImages.g01, points: 200, redeemedCount: 32, issuedCount: 20, status: '正发放',
    recipients: [
  ...
  { id: 'e02', giftId: 'g02', giftName: '向日葵马克杯', image: giftImages.g02, points: 300, redeemedCount: 18, issuedCount: 18, status: '已发放', recipients: [] },
  { id: 'e03', giftId: 'g03', giftName: '星空马克杯', image: giftImages.g03, points: 300, redeemedCount: 23, issuedCount: 18, status: '正发放', recipients: [] },
  { id: 'e04', giftId: 'g04', giftName: '小招喵纸巾盒', image: giftImages.g04, points: 500, redeemedCount: 12, issuedCount: 0, status: '待发放', recipients: [] },
  { id: 'e05', giftId: 'g05', giftName: '小招喵方形周边', image: giftImages.g05, points: 800, redeemedCount: 9, issuedCount: 7, status: '正发放', recipients: [] },
  { id: 'e06', giftId: 'g06', giftName: '小招喵马克杯', image: giftImages.g06, points: 500, redeemedCount: 26, issuedCount: 26, status: '已发放', recipients: [] },
]
